...
## 相关性分析结果
- 加入了一些负收益的基金后，可以观察到波动性跟收益率相关性非常高，default 跟 volatility 相关性为 0.8029，t_strategy 跟 volatility 相关性为 0.8406，dynamic_strategy 跟 volatility （threshold = 1.0）相关性为 0.8792。
